// src/components/AdminPortal/AdminLogin.jsx
        ...
        <div className="hidden md:flex w-full md:w-1/2 h-full items-center justify-center p-4 lg:p-8 relative">
          <div className="relative w-full max-w-md">
            ...
            <div className="relative bg-white p-4 lg:p-8 rounded-2xl shadow-xl border border-gray-200 z-10">
              <h2 className="text-xl lg:text-2xl font-bold text-[#800000] mb-4">Admin Portal Benefits</h2>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-sm lg:text-base">Comprehensive dashboard to manage student accounts</p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm lg:text-base">Real-time transaction monitoring and approval</p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm lg:text-base">Complete financial reporting and analytics</p>
                </li>
              </ul>
            </div>
          </div>
          
          <div className="absolute right-[-6rem] bottom-0 w-64 md:w-72 lg:w-96 h-auto z-20 pointer-events-none">
            <img 
              src={loginpic}
              alt="Admin pointing" 
